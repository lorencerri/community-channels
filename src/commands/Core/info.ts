...
export class InfoCommand extends Command {
	async chatInputRun(interaction: Command.ChatInputInteraction) {
		...
		const embed = new MessageEmbed()
			.setColor(0x8087f6)
			.setDescription(`Community channels is an open-source Discord bot created by **@lorencerri** ([GitHub](https://github.com/lorencerri) | [Twitter](https://twitter.com/lorencerri)), originally for the [Hypnospace](https://lorencerri.notion.site/Hypnospace-a51c36d0b3614e82a1426bb9681f0ff6) Discord server.\n\n**Links:**\n[Commands](https://lorencerri.notion.site/Commands-9159d2d30d15429f8b35119ebced6a2c)\n[Documentation](https://lorencerri.notion.site/lorencerri/Community-Channels-75b1c971513c4b429b5071f1357e38f0)\n[Source Code](https://github.com/lorencerri/community-channels)`)
